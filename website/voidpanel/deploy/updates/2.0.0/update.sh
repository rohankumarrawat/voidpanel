#!/bin/bash
# ============================================================
#  VoidPanel Update Script — v2.0.0
#  https://voidpanel.com/updates/2.0.0/update.sh
# ============================================================
set -euo pipefail
...
# 8. Restart
log "Restarting voidpanel service ..."
