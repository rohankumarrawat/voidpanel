...
child = pexpect.spawn('scp -o StrictHostKeyChecking=no control/views.py root@178.18.250.134:/var/www/panel/website/voidpanel/control/views.py', timeout=60, encoding='utf-8')
